  ...
  return (
    <section className="rounded-lg border border-stone-light bg-forest px-6 py-7 text-paper-light shadow-paper">
      <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
        <div>
          <p className="font-mono text-xs uppercase tracking-[0.1em] text-sage-light">Student File · Grade 11 · 2025-2026</p>
          <h1 className="mt-3 font-display text-6xl leading-none">{student.name}.</h1>
          <div className="mt-4 flex flex-wrap gap-2">
            <Badge className="border-sage bg-sage-light text-forest">{student.personalityType}</Badge>
