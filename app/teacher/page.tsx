...
export default function TeacherRosterPage() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-10">
      ...
      <p className="mt-3 max-w-2xl text-ink-soft">One demo student is active. The layout is ready for a full classroom roster.</p>
      <Card className="mt-8 overflow-hidden">
        ...
        <Link href="/teacher/students/maya" className="grid grid-cols-[1.5fr_0.7fr_1fr_0.8fr_40px] items-center px-5 py-5 hover:bg-sage-light/30">
          ...
          <span className="text-sm text-ink-soft">Prepared debate rebuttal · current</span>
